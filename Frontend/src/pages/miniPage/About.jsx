...
const About = () => {
  return (
    <div className='container mx-auto px-4 py-12 sm:px-6 lg:px-50 mt-20 bg-gradient-to-r from-blue-500 to-purple-500 rounded-2xl'>
      ...
      <p className='text-lg'>
        Our team consists of passionate writers and experts in different fields who are committed to delivering high-quality content. We hope you enjoy reading our articles as much as we enjoy writing them.
      </p>
    </div>
  )
}
