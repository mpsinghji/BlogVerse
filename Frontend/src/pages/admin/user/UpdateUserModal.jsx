        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm">
            ...
            <div className="relative bg-white/95 backdrop-blur-sm rounded-xl shadow-2xl max-w-md w-full mx-4 p-6 transition-all">
                ...
                <div className="border-b border-gray-200/80 pb-4 mb-6">
                    <h2 className="text-2xl font-semibold text-gray-800/90">Edit User Role</h2>
                </div>

                {/* Email field */}
                <div className="mb-6 space-y-2">
                    <label className="block text-sm font-medium text-gray-700/90">Email</label>
                    <input
                        type="text"
                        value={user?.email}
                        readOnly
                ...
                <div className="mb-8 space-y-2">
                    <label className="block text-sm font-medium text-gray-700/90">Role</label>
                    <select 
                        value={role} 
