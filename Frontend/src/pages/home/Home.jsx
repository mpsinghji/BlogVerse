  ...
  return (
    <div className="min-h-screen  pt-20">
      <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
        {/* Hero Section */}
        <div className="relative backdrop-blur-lg rounded-2xl border bg-gradient-to-r from-purple-600 to-cyan-500 shadow-2xl shadow-purple-500/20 overflow-hidden">
        ...
        <div className="mt-16 space-y-12">
          <h2 className="text-4xl md:text-5xl font-bold bg-black pb-2 bg-clip-text text-transparent text-center">
            Latest Insights
          </h2>
            <Blogs />
        </div>
